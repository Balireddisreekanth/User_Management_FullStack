...
app.post('/updateuser/:id', (req, res) => {
    ...
    connection.query('update  `student` set firstname="' + req.body.firstname + '",email="' + req.body.email + '",password="' + req.body.password + '",course="' + req.body.course + '",content="' + req.body.content + '",start="' + req.body.start + '",end="' + req.body.end + '",project="' + req.body.project + '",total="' + req.body.total + '",paid="' + req.body.paid + '",remaining="' + req.body.remaining + '", roletype="' + req.body.roletype + '", assigned_to="' + req.body.assigned_to + '",status="' + req.body.status + '",fee_detail="' + req.body.fee_detail + '",paymode="' + req.body.paymode + '" where id="' + req.params.id + '"', (err, row, fields) => {
