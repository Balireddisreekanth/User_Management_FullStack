        ...
        <>
            <section >
             ...
             {tutorinfo.map((item) =>
                ...
                <div id="layout" style={{ display: "grid",gridTemplateColumns:'auto auto auto ', gap: "30px", boxShadow: "2px 8px 32px 2px gray", margin: "30px 0 0 150px", borderRadius: '10px', width: '850px'}}>
                ...
                <div id="contdetails" style={{display:'none'}}><h5>
                <button onClick={back} style={{borderRadius:'10px',backgroundColor:"rgba(37, 117, 252, 1)",fontWeight:'bold',margin:'-300px 0 0 0'}}><Link to={'/users'} style={{color:"white",textDecoration:"none"}}>Back</Link></button> &nbsp;
                    ...
                    <div id="feedbackdetails" style={{display:'none'}}><h5>
                <button onClick={back} style={{borderRadius:'10px',backgroundColor:"rgba(37, 117, 252, 1)",fontWeight:'bold',margin:'-300px 0 0 0'}}><Link to={'/users'} style={{color:"white",textDecoration:"none"}}>Back</Link></button> &nbsp;
