          ...
          <div className="container " style={{ padding: '8%' }}>
            <div className="row d-flex justify-content-center align-items-center h-100">
              <div className="col-12 col-md-9 col-lg-7 col-xl-6">
                <div className="card" style={{margin:"-80px 0 0 0",borderRadius:"5px"}} >
                  <div className="card-body p-5" style={{ height: '600px' }} >
                    ...
                    <form style={{ height: '600px' }}>
                      ...
                      {/* <div className="form-outline mb-4">
                        ...
                        <input type="text" name="lastname" id="form3Example2cg" className="form-control form-control-lg" onChange={handler} />
                      </div> */}
                      ...
                      {/* <div className="form-outline mb-4">
                        ...
                        <input type="number" name="phone_number" id="form3Example5cdg" className="form-control form-control-lg" onChange={handler} />
